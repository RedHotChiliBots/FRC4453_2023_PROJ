...
import frc.robot.commands.AutonBalanceTest;
...
public class Autos {
        ...
        public Command autonBalanceTest() {
                return new AutonBalanceTest(
                                RobotContainer.chassis, RobotContainer.crane,
                                RobotContainer.craneTurret,
                                RobotContainer.craneTilt,
                                RobotContainer.craneArm,
        ...
        public void init() {
                ...
                Command autonPlace = new AutonInitialMove2Node(
                                ...
                                RobotContainer.craneTilt, RobotContainer.craneArm, RobotContainer.claw,
                ...
                chooser.addOption("Score Balance (dist)", autonPlaceBalance);
                chooser.addOption("Score Mobility Balance", autonBalance());
                ...
                chooser.addOption("TEST ScoreMobilityBalance", autonBalanceTest());
