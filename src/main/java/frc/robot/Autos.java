...
//        Map.entry("stop", new InstantCommand(() -> chassis.drive(new Translation2d(0,0), 0, true, true)))
//        Map.entry("balance", new Balance(RobotContainer.s_Swerve))
    ...
    //         new PIDConstants(7.3, 0.001, 0.01), // PID constants to correct for translation error (used to create the X
    //                                             // and Y PID controllers)
    //         new PIDConstants(1.8, 0, 0.004), // PID constants to correct for rotation error (used to create the rotation
    //                                          // controller)
    //         RobotContainer.s_Swerve::setModuleStates, // Module states consumer used to output to the drive subsystem
    //         eventMap,
    //         true, // Should the path be automatically mirrored depending on alliance color.
    //               // Optional, defaults to true
    //         RobotContainer.s_Swerve // The drive subsystem. Used to properly set the requirements of path following
    //                                 // commands
    // );
    
//    RamseteAutoBuilder autoB = new RamseteAutoBuilder(null, null, null, null, null, eventMap, null)


//     private static final RamseteAutoBuilder autoBuilder = new RamseteAutoBuilder(
//             chassis::getPose, // Pose2d supplier
//             chassis::resetOdometry, // Pose2d consumer, used to reset odometry at the beginning of auto
//             chassis::ramseteController,
