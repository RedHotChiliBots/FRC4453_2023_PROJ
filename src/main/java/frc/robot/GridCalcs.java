...
public class GridCalcs {
	...
	private final EnumMap<NODEPOS, Map<V, Map<H, Map<E, Map<CRANEAXIS, Double>>>>> kNodePos = new EnumMap<>(Map.of(
			...
			Map.of(V.TOP,
					Map.of(H.LEFT,
							Map.of(E.CUBE,
									Map.of(CRANEAXIS.TURRET, 180.0 - 21.25,
											CRANEAXIS.TILT, 15.0,
											CRANEAXIS.ARM, 25.0),
									E.CONE,
									Map.of(CRANEAXIS.TURRET, 180.0 - 21.25,
					...
					Map.of(H.LEFT,
							Map.of(E.CUBE,
									Map.of(CRANEAXIS.TURRET, 180.0 - 22.25,
											CRANEAXIS.TILT, -5.0,
											CRANEAXIS.ARM, 25.0),
									E.CONE,
									Map.of(CRANEAXIS.TURRET, 180.0 - 22.25,
					...
					Map.of(H.LEFT,
							Map.of(E.CUBE,
									Map.of(CRANEAXIS.TURRET, 180.0 - 23.25,
											CRANEAXIS.TILT, -30.0,
											CRANEAXIS.ARM, 25.0),
									E.CONE,
									Map.of(CRANEAXIS.TURRET, 180.0 - 23.25,
			...
			Map.of(V.TOP,
					Map.of(H.LEFT,
							Map.of(E.CUBE,
									Map.of(CRANEAXIS.TURRET, 0.0 - 21.25,
											CRANEAXIS.TILT, 15.0,
											CRANEAXIS.ARM, 25.0),
									E.CONE,
									Map.of(CRANEAXIS.TURRET, 0.0 - 21.25,
					...
					Map.of(H.LEFT,
							Map.of(E.CUBE,
									Map.of(CRANEAXIS.TURRET, 0.0 - 22.25,
											CRANEAXIS.TILT, -5.0,
											CRANEAXIS.ARM, 25.0),
									E.CONE,
									Map.of(CRANEAXIS.TURRET, 0.0 - 22.25,
					...
					Map.of(H.LEFT,
							Map.of(E.CUBE,
									Map.of(CRANEAXIS.TURRET, 0.0 - 23.25,
											CRANEAXIS.TILT, -30.0,
											CRANEAXIS.ARM, 25.0),
									E.CONE,
									Map.of(CRANEAXIS.TURRET, 0.0 - 23.25,
