...
public class AutonScoreAtNode extends SequentialCommandGroup {
  /** Creates a new AutonCranePos. */
  public AutonScoreAtNode(Crane crane, CraneTurret craneTurret, CraneTilt craneTilt, CraneArm craneArm,
      Claw claw) {
