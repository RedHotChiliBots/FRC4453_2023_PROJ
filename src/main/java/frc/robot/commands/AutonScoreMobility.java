...
public class AutonScoreMobility extends SequentialCommandGroup {
  Chassis chassis;
  Crane crane;
  ...
  public AutonScoreMobility(Chassis chassis, Crane crane, CraneTurret craneTurret, CraneTilt craneTilt,
